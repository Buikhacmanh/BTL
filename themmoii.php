...
<body>
         <?php
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                //1. Lấy thông tin từ form dữ liệu và lưu vào biến
                $mahang = $_GET['mahang'];
                ...
                $xuatxu = $_POST['xuatxu'];
                $mota = $_POST['mota'];
                //echo $mahang . ", " . $tenhang . ", " . $gia . ", " . $hinhanh . ", " . $xuatxu . ", " . $mota . "<br/>";
                //2.Kết nối CSDL
                ...
                $sql = "INSERT INTO themsp (MaHang, TenHang, Gia, XuatXu, MoTa, HinhAnh) VALUES('" . $mahang . "', '" . $tenhang . "', '" . $gia . "', '" . $xuatxu . "', '" . $mota . "', '" . $hinhanh . "')";
                //echo $sql;
                //4.Thực hiện truy vấn
                if (mysqli_query($conn, $sql)) {
                    //Nếu thêm sản phẩm thành công chuyển đến trang quantri.php
                    //5.Hiển thị kết quả
                    header("Location: admin.php?tukhoa=&timkiem=Tìm+kiếm");//Chuyển đến trang quantri.php
                }
        ...
        <div class="so2">
            ...
            <form action="themmoii.php" method="POST">
                    <table class="so3">
                        <tr>
                            <td><label>Tên mặt hàng: </label></td>
                            <td><input type="text" name="tenhang" required=""></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><textarea rows="10" cols="80" name="mota"></textarea> <br></td>
                        </tr>
                        <tr>
