    ...
    <div class="container">
            ...
            <div class="up">
				<ul>
					...
					<li>
                        ...
                        <a href="dangkyy.php"><label for="">Đăng Kí</label></a>
                        <a href="dangnhapp.php"><label for="">Đăng Nhập</label></a>
        ...
        <div class="the3">
			...
			<div class = "so1">
					...
					<div>
						<?php echo $row['Gia'];?><label for="">đ</label>
					</div>
					<div>
						<a href="thongtinsanpham2.php?mahang=thongtin&mahang=<?php echo $row['MaHang'];?>">Thông tin sản phẩm</a>
					</div>
			</div>
		</div>
            <?php
